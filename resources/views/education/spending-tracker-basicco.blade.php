...
@push('styles')
    ...
    <style>
        ...
        * {
        ...
        .balance-label { font-size: 12px; color: #8a6d1d; font-weight: 600; margin-bottom: 4px; }
        ...
        .item-card:hover {
            ...
            background: #EEF9F5;
            box-shadow: 0 2px 8px rgba(0, 164, 125, 0.12);
        }
        ...
        .form-control {
            ...
            font-size: 13px; transition: 0.15s; background: #fff;
        }
        .form-control:focus { outline: none; border-color: var(--primary-teal); background: white; box-shadow: 0 0 0 3px rgba(0, 164, 125, 0.15); }
        ...
        .btn-pay:disabled { background: #9FD8CB; border-color: #9FD8CB; cursor: not-allowed; transform: none; box-shadow: none; }
