            ...
            <div class="max-w-[600px] mx-auto w-full bg-white border border-color-[#D2DDDB] rounded">
                <form action="#" method="post">
                    <div class="quizeIntroSteps p-10" id="quizeIntroText">
                        <h2 class="text-xl font-semibold mb-4 text-center">Introduction to Budget and Why Have a Budget?</h2>
                        <div id="questionTxtCarou" class="relative w-full">
                            ...
                            <div class="quizSliderContent">
                                ...
                                <div class="duration-200 ease-linear quizQuesTab active">
                                    <div class="introText text-center mt-4">
                                        <p class="mb-2 text-lg">How are you feeling? 😊 </p>
                                    </div>
                                </div>
                            </div>
                            <!-- Questions -->
                            <div class="tab-nav flex justify-center gap-4 mt-8">
                        ...
                        <div class="quizQuestionSecItem" id="questionansSet">
                            <div class="quizQuestionSec">
                                <div class="singleQuiz active">
                                    <div class="quesHeading p-4 border-b border-color-[#D2DDDB] shadow-sm">
                                        <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
                                            ...
                                            <span class="text-sm font-semibold">1/10</span>
                                        </div>
                                ...
                                <div class="singleQuiz">
                                    <div class="quesHeading p-4 border-b border-color-[#D2DDDB] shadow-sm">
                                        <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
                                            ...
                                            <span class="text-sm font-semibold">2/10</span>
                                        </div>
                                    ...
                                    <div class="questionLists p-4">
                                        <div class="quizItems">
                                            ...
                                            <label for="qsetques2_1" class="quizLabel">Spend all your money at once</label>
                                        </div>
                                        <div class="quizItems">
                                ...
                                <div class="singleQuiz">
                                    <div class="quesHeading p-4 border-b border-color-[#D2DDDB] shadow-sm">
                                        <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
                                            ...
                                            <span class="text-sm font-semibold">3/10</span>
                                        </div>
                                ...
                                <div class="singleQuiz">
                                    <div class="quesHeading p-4 border-b border-color-[#D2DDDB] shadow-sm">
                                        <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
                                            ...
                                            <span class="text-sm font-semibold">4/10</span>
                                        </div>
                                    ...
                                    <div class="questionLists p-4">
                                        ...
                                        <div class="quizItems">
                                            ...
                                            <label for="qsetques4_3" class="quizLabel">Ignoring your expenses</label>
                                        </div>
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet4" id="qsetques4_4">
                                            <label for="qsetques4_4" class="quizLabel">Borrowing more money</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="singleQuiz">
                                ...
                                <div class="singleQuiz">
                                    <div class="quesHeading p-4 border-b border-color-[#D2DDDB] shadow-sm">
                                        <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
                                            <h4 class="text-xl font-semibold">Question 6</h4>
                                            <span class="text-sm font-semibold">6/10</span>
                                        </div>
                                        <h2 class="questionTitle text-2xl font-semibold">Why is tracking spending an important part of budgeting?</h2>
                                    </div>
                                    <div class="questionLists p-4">
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet6" id="qsetques6_1">
                                            <label for="qsetques6_1" class="quizLabel">It helps you spend more money carelessly.</label>
                                        </div>
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet6" id="qsetques6_2" data-correct="true">
                                            <label for="qsetques6_2" class="quizLabel">It shows exactly how much money you have and where it’s being used.</label>
                                        </div>
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet6" id="qsetques6_3">
                                            <label for="qsetques6_3" class="quizLabel">It prevents you from ever needing to save.</label>
                                        </div>
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet6" id="qsetques6_4">
                                            <label for="qsetques6_4" class="quizLabel">It guarantees you’ll get a loan.</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="singleQuiz">
                                    <div class="quesHeading p-4 border-b border-color-[#D2DDDB] shadow-sm">
                                        <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
                                            <h4 class="text-xl font-semibold">Question 7</h4>
                                            <span class="text-sm font-semibold">7/10</span>
                                        </div>
                                        <h2 class="questionTitle text-2xl font-semibold">How does a budget help with saving for goals?</h2>
                                    </div>
                                    <div class="questionLists p-4">
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet7" id="qsetques7_1">
                                            <label for="qsetques7_1" class="quizLabel">By allowing you to spend all your money at once.</label>
                                        </div>
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet7" id="qsetques7_2" data-correct="true">
                                            <label for="qsetques7_2" class="quizLabel">By helping you save a little bit at a time toward your goal.</label>
                                        </div>
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet7" id="qsetques7_3">
                                            <label for="qsetques7_3" class="quizLabel">By making your goals less important.</label>
                                        </div>
                                        <div class="quizItems">
                                            <input type="radio" class="hidden" name="questionSet7" id="qsetques7_4">
                                            <label for="qsetques7_4" class="quizLabel">By forcing you to take out loans.</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="singleQuiz">
