            ...
            <div class="w-full">
                <div class="main" id="mainArea">
                    <div class="content">
                        ...
                        <div class="page-subheading">Track your emotional wellness and how your class is feeling each month.
                        </div>
        ...
        (function () {
            ...
            function renderCity() {
                ...
                if (current && (current.totalLogs > 0 || current.daysLogged > 0)) {
                    const cm = moodById(current.dominantMood);
                    const q = QS[cm.q];
                ...
                pastListEl.innerHTML = past.map(r => {
                    const m = moodById(r.dominantMood);
                    const pq = QS[m.q];
                    return `
                <div class="past-card">
