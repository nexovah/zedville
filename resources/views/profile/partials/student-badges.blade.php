<style>
  * {
  ...
  .month-header-cell.current-h {
    color: var(--color-text-primary);
    font-weight: 500;
  }

  .month-header-cell.future-h {
    opacity: 0.35;
  }
  ...
  .month-cell:not(.future) {
    transition: background 0.15s ease;
  }

  .month-cell:not(.future):hover {
    background: var(--color-background-secondary);
  }
</style>
...
<svg width="0" height="0" style="position:absolute" aria-hidden="true">
  <defs>
    ...
    <symbol id="m-platinum" viewBox="0 0 120 130">
      ...
      <!-- Letter -->
      <text x="60" y="82" text-anchor="middle" font-size="28" font-weight="500" fill="#3A3A42" font-family="serif"
    ...
    <symbol id="m-gold" viewBox="0 0 120 130">
      ...
      <text x="60" y="82" text-anchor="middle" font-size="28" font-weight="500" fill="#5C4500" font-family="serif"
    ...
    <symbol id="m-silver" viewBox="0 0 120 130">
      ...
      <text x="60" y="82" text-anchor="middle" font-size="28" font-weight="500" fill="#333" font-family="serif"
    ...
    <symbol id="m-bronze" viewBox="0 0 120 130">
      ...
      <text x="60" y="82" text-anchor="middle" font-size="28" font-weight="500" fill="#3A1F0A" font-family="serif"
    ...
    <symbol id="m-eng-none" viewBox="0 0 120 130">
      ...
      <text x="60" y="82" text-anchor="middle" font-size="24" font-weight="400" fill="#B8B8B8"
    ...
    <symbol id="m-legend" viewBox="0 0 120 130">
      ...
      <path d="M 60 22 L 96 32 L 96 64 Q 96 92 60 110 Q 24 92 24 64 L 24 32 Z" fill="#A8801C" />
      <!-- Shield body with gradient -->
      <path d="M 60 24 L 94 33 L 94 64 Q 94 90 60 107 Q 26 90 26 64 L 26 33 Z" fill="url(#g-legend-shield)" />
      <!-- Inner border -->
      <path d="M 60 30 L 88 38 L 88 63 Q 88 85 60 100 Q 32 85 32 63 L 32 38 Z" fill="none" stroke="#FFE89C"
      ...
      <!-- Star highlight -->
      <path d="M 60 46 L 63.5 57.5 L 75 57.5 L 67 65 Z" fill="#FFE89C" opacity="0.4" />
    </symbol>

    <symbol id="m-champion" viewBox="0 0 120 130">
      <path d="M 60 14 L 96 24 L 96 56 Q 96 84 60 102 Q 24 84 24 56 L 24 24 Z" fill="#1F5F9F" />
      <path d="M 60 16 L 94 25 L 94 56 Q 94 82 60 99 Q 26 82 26 56 L 26 25 Z" fill="url(#g-champion-shield)" />
      <path d="M 60 22 L 88 30 L 88 55 Q 88 77 60 92 Q 32 77 32 55 L 32 30 Z" fill="none" stroke="#A8D0F5"
        stroke-width="0.8" opacity="0.6" />
      <!-- 4-point star (compass-like) -->
      <path d="M 60 38 L 67 56 L 84 60 L 67 64 L 60 82 L 53 64 L 36 60 L 53 56 Z" fill="#0C447C" opacity="0.85" />
    ...
    <symbol id="m-finhero" viewBox="0 0 120 130">
      <path d="M 60 14 L 96 24 L 96 56 Q 96 84 60 102 Q 24 84 24 56 L 24 24 Z" fill="#0F6E56" />
      <path d="M 60 16 L 94 25 L 94 56 Q 94 82 60 99 Q 26 82 26 56 L 26 25 Z" fill="url(#g-finhero-shield)" />
      <path d="M 60 22 L 88 30 L 88 55 Q 88 77 60 92 Q 32 77 32 55 L 32 30 Z" fill="none" stroke="#A8E5CC"
        stroke-width="0.8" opacity="0.6" />
      <!-- Coin design with Z -->
      ...
      <text x="60" y="68" text-anchor="middle" font-size="22" font-weight="500" fill="#04342C" font-family="serif"
        font-style="italic">z</text>
      <!-- Highlight on coin -->
      <ellipse cx="54" cy="52" rx="6" ry="4" fill="#FFFFFF" opacity="0.3" transform="rotate(-30 54 52)" />
    </symbol>

    <symbol id="m-rookie" viewBox="0 0 120 130">
      <path d="M 60 14 L 96 24 L 96 56 Q 96 84 60 102 Q 24 84 24 56 L 24 24 Z" fill="#7A7975" />
      <path d="M 60 16 L 94 25 L 94 56 Q 94 82 60 99 Q 26 82 26 56 L 26 25 Z" fill="url(#g-rookie-shield)" />
      <path d="M 60 22 L 88 30 L 88 55 Q 88 77 60 92 Q 32 77 32 55 L 32 30 Z" fill="none" stroke="#FFFFFF"
        stroke-width="0.8" opacity="0.6" />
    ...
    <symbol id="m-fh-none" viewBox="0 0 120 130">
      <path d="M 60 14 L 96 24 L 96 56 Q 96 84 60 102 Q 24 84 24 56 L 24 24 Z" fill="#F5F5F5" stroke="#D0D0D0"
        stroke-width="0.8" stroke-dasharray="3 3" />
      <text x="60" y="68" text-anchor="middle" font-size="24" font-weight="400" fill="#B8B8B8"
        font-family="serif">·</text>
    </symbol>
  </defs>
</svg>
...
<script>
  (function () {
    ...
    //console.log('ENG:', @json($engagement));
    //console.log('FINHERO:', @json($finhero));
    /* Fix history keys */
    ...
    /* ============================
       DATE LOGIC
    ============================ */
    const currentMonth = engData.currentMonth;
    const currentYear = engData.currentYear;

    const academicStartMonth = engData.academicStartMonth;
    ...
    function renderHistory() {
      ...
      function renderRow(rowId, data, medals) {
        ...
        months.forEach(({ month, year }) => {
          ...
          const badge =
            data.history[String(month)] ??
            (isCurrent ? data.monthly : null);
