<div class="survey-container">
    <div class="survey-header">
        <h1 class="text-xl xl:text-2xl 2xl:text-3xl font-bold text-gray-900">🎓 Consumer Profile Survey</h1>
        <p>Help us understand your monthly expenses</p>
...
.tooltip-wrapper:hover .custom-tooltip {
    ...
    <div class="survey-content">
        ...
        <div class="step active" data-step="1">
            <h2 class="step-title">📋 Before We Begin</h2>
        ...
        <div class="step" data-step="2">
            <h2 class="step-title">🍽️ What's Your Diet?</h2>
