...
@push('scripts')
    ...
    <script>
        ...
        function renderProducts() {
            ...
            <tr data-id="${p.id}">
                ...
                <td>
                    ${p.image ? `
                        <img src="https://zedville.nexovah.in/public/uploads/products/${p.image}" width="40">
                    ` : ''}
        ...
        function saveRow(r) {
            ...
            fetch(`/admin/education/products-update/${id}`, {
                method: 'POST',
                headers: { 'X-CSRF-TOKEN': '{{ csrf_token() }}' },
                body: fd
            })
    ...
    /*function deleteProduct(btn){
        ...
        const r=btn.closest('tr');
        showLoader();
        fetch(`/admin/education/products-delete/${r.dataset.id}`,{
            method:'DELETE',
            headers:{'X-CSRF-TOKEN':'{{ csrf_token() }}'}
