...
@section('title', 'Electricity Bill Auto-Pay Authorization')

@section('content')
<div class="flex flex-col items-start justify-between pb-6 space-y-4 lg:items-center lg:space-y-0 lg:flex-row">
    <h1 class="text-xl font-bold whitespace-nowrap">Electricity Bill Auto-Pay Authorization</h1>
</div>
        ...
        <form action="{{ route('bank.store_auto_debit') }}" method="post">
            ...
            <div class="depostFormSec">
                ...
                <div class="flex flex-wrap lg:flex-nowrap gap-4">
                    <div class="w-full lg:w-[50%]">
                        <div class="mb-4 form-group">
                            <label class="block mb-2 text-md font-medium text-black">Electricity Account No</label>
                            <input class="form-control" placeholder="Electricity Account No" type="text" name="accountno" />
                        </div>
                    </div>
                    <div class="w-full lg:w-[50%]">
                        <div class="mb-4 form-group">
                ...
                <div class="mt-6 border-t border-[#D2DDDB] pt-6">
                    ...
                    <p class="mb-4">"I authorize <a href="#" target="_blank" class="text-themegreen font-semibold">ABC Electric Utility Co.</a> to debit my account for bill payments. I will receive payment alerts and can cancel anytime in writing. I confirm the account details are correct."</p>
