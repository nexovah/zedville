...
@push('styles')
    ...
    <style>
        ...
        * {
        ...
        .survey-info-box h2 { font-size: 22px; font-weight: bold; margin-bottom: 8px; }
        .survey-info-box p { color: #555; font-size: 15px; margin-bottom: 15px; }
        ...
        .survey-placeholder h3 { margin: 0 0 15px; font-size: 22px; color: #333; }
        .survey-placeholder p { margin: 0 0 20px; color: #666; font-size: 16px; }
    </style>
@endpush
    ...
    <div class="themeTabspills">
        <div class="w-full">
            <div class="survey-info-box">
                ...
                <button class="btn btn-primary" id="openResultBtn">View Survey Result</button>
            </div>

            <div class="tailCard w-full rounded-lg" x-data="{ changeImageModal: false, moodMeater: false }">

                {{-- ✅ FIX 1: Removed "show" class — popup was opening on page load --}}
                ...
                <div>
                    <div class="app-grid">
                        ...
                        <div class="tracker-section section-card">
                            ...
                            {{-- ✅ FIX 2: Validation bar defined in HTML so it always exists in DOM --}}
                            ...
                            <div class="checkout-box">
                                ...
                                {{-- ✅ FIX 3: Removed onclick — bound via addEventListener below --}}
...
<script>
    ...
    // ── Validation Bar ────────────────────────────────────
    // ✅ FIX: Use the bar already in DOM — no dynamic createElement needed
    function showValidationBar(message, type = 'info') {
        ...
        bar.style.display    = 'block'; // ✅ Always set display:block here
    ...
    document.addEventListener('DOMContentLoaded', () => {
        // ✅ FIX: Bind payButton via addEventListener — onclick on disabled button was bypassing validation
        document.getElementById('payButton')
            .addEventListener('click', processPayment);

        // ✅ FIX: Bind modal buttons via addEventListener — no inline onclick needed
