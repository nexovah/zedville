...
<div class="zvHome max-w-5xl mx-auto space-y-4">
    ...
    <section aria-label="Mailbox">
        <div class="rounded-xl bg-[#F1FCF8] border border-[#D2DDDB] px-4 py-3 flex items-center gap-3">
            ...
            <a href="{{ route('profile.mailbox') }}" class="rounded-full border border-[#D2DDDB] bg-white hover:bg-[#EEF9F5] text-sm font-medium px-4 py-1.5">Open</a>
        </div>
    </section>
